class Config(object):
    DEBUG = False
    TESTING = False
    SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:clean_msa@postgres-alarm:5432/postgres'
...
class QAConfig(Config):
    DEBUG = True
    TESTING = False
    SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:clean_msa@localhost:35433/postgres'
